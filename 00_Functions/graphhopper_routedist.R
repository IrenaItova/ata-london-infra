...
graphhopper_routedist <- function(from, to, vehicle = NULL, startid = NULL, endid = NULL, pat = NULL, base_url = "https://graphhopper.com", routeshape = F) {
